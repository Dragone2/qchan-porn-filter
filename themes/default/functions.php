...
function format_message() {
	return json_encode(array(
		'err' => array(
			...
			'porn_detected' => __(' is a porn image.'),
		...
		'err_detail' => array(
			...
			'porn_detected' => __('We do not allow the upload of porn images.'),
...
function format_main_site() {
	if(MAIN_SITE) {
		if(MAIN_SITE_LOGO!==''){
			return '<p id="main_site"><a target="_blank" href="'.MAIN_SITE_URL.'"><img src="'.MAIN_SITE_LOGO.'" alt="Image Hosting" title="'.MAIN_SITE_NAME.'"></a></p>';
		}else {
